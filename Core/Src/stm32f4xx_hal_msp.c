...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(I2C_POT_SCL_GPIO_Port, I2C_POT_SCL_Pin);

    HAL_GPIO_DeInit(I2C_POT_SDA_GPIO_Port, I2C_POT_SDA_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA5     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(GPIOA, ENCODER1_CH2_Pin|ENCODER1_CH1_Pin);
